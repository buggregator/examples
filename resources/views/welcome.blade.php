...
<head>
    ...
    <title>Buggregator - All-in-One PHP Debugging Solution | Lightweight & Powerful</title>
</head>
<body>
    ...
    <div class="bg-gray-100">
        <div class="max-w-screen-lg xl:max-w-screen-xl mx-auto py-10 px-5 md:px-8 lg:px-16 my-6">
            ...
            <p class="max-w-screen-lg text-lg sm:text-2xl font-semibold text-gray-500 mb-10 sm:mb-11 text-white">
                Buggregator is your one-stop lightweight debugging server tailor-made for PHP applications. Whether
                you're a seasoned developer or taking your first steps, Buggregator equips you with advanced features
                making issue identification and resolution a breeze.
            </p>

            <div class="text-sm mb-6 border bg-white rounded-lg px-5 py-3">
                <p class="max-w-screen-lg font-medium text-gray-400 mb-2">
                    All you need to do is to run the following command in your terminal to start the server and it will
                    be ready to receive events from your application:
                </p>
                <div
    ...
    <div class="max-w-screen-lg xl:max-w-screen-xl mx-auto py-10 px-5 md:px-8 lg:px-16 my-6">
        ...
        <a href="#demo" class="flex flex-col items-center">
            ...
            <div class="animate-bounce text-purple-500">
                <svg class="fill-current h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 330 330"
                     xml:space="preserve"><path
                        d="M326 79c-6-5-16-5-22 0L165 219 26 79a15 15 0 0 0-22 22l150 150a15 15 0 0 0 22 0l150-150c5-6 5-16 0-22z"/></svg>
            </div>
        </a>
        @endif

        <div class="px-4 xs:px-6 md:px-8 my-5 md:my-10 lg:my-20">
            ...
            <div class="flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-5 justify-center">
                <a href="https://github.com/butschster" target="_blank" class="flex flex-col items-center justify-start">
                ...
                <a href="https://github.com/roxblnfk" target="_blank" class="flex flex-col items-center justify-start">
                    <div class="p-1 border-2 border-blue-400 rounded-full">
                        <img src="https://avatars.githubusercontent.com/u/4152481?v=4" alt=""
                             class="w-16 h-16 rounded-full bg-blue-200" loading="lazy">
                    </div>
                ...
                <a href="https://github.com/rustatian" target="_blank" class="flex flex-col items-center justify-start">
                    <div class="p-1 border-2 border-blue-400 rounded-full">
                        <img src="https://avatars.githubusercontent.com/u/8040338?v=4" alt=""
                             class="w-16 h-16 rounded-full bg-blue-200" loading="lazy">
                    </div>
                    <div class="text-gray-900 text-xl font-medium">Valery Piashchynski</div>
                    <div class="text-blue-600 text-sm font-bold">GO developer</div>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="relative">
        ...
        <div class="max-w-screen-lg xl:max-w-screen-xl mx-auto py-10 px-5 md:px-8 lg:px-16">
            ...
            <div class="mb-5 sm:mb-16 md:mb-20 lg:mb-32" id="{{ $group }}">
                ...
                <p class="max-w-4xl text-lg sm:text-2xl text-gray-500 font-medium sm:leading-10 mb-6">
                    {{ $data['description'] }}</p>
                @endif

                <div class="p-5 md:p-8 lg:p-10 bg-gray-50 border border-blue-200 rounded-xl">
                    <p class="text-sm text-gray-400 font-bold mb-4">Click a button to send an event to Buggregator
                        server.</p>
        ...
        template: `
            <div class="flex flex-col items-center h-full">
                <div class="flex justify-center mb-5">
                    <button class="p-1 rounded" @click="device = 'mobile'"
                            :class="{'bg-blue-50 text-blue-600': device == 'mobile'}">
                        <svg class="w-10 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 53">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                  d="M9 1H2a1 1 0 0 0-1 1v49c0 .6.4 1 1 1h24c.6 0 1-.4 1-1V2c0-.6-.4-1-1-1h-7c0 .6-.4 1-1 1h-8a1 1 0 0 1-1-1ZM2 0a2 2 0 0 0-2 2v49c0 1.1.9 2 2 2h24a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2Zm14 49a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z"/>
                        </svg>
                    </button>
                    <button @click="device = 'tablet'" class="p-1 rounded"
                            :class="{'bg-blue-50 text-blue-600': device == 'tablet'}">
                        <svg class="w-10 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 38 53">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                  d="M14 1H2a1 1 0 0 0-1 1v49c0 .6.4 1 1 1h34c.6 0 1-.4 1-1V2c0-.6-.4-1-1-1H24c0 .6-.4 1-1 1h-8a1 1 0 0 1-1-1ZM2 0a2 2 0 0 0-2 2v49c0 1.1.9 2 2 2h34a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2Zm32 4H4a1 1 0 0 0-1 1v39c0 .6.4 1 1 1h30c.6 0 1-.4 1-1V5c0-.6-.4-1-1-1ZM4 3a2 2 0 0 0-2 2v39c0 1.1.9 2 2 2h30a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H4Zm15 48a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/>
                        </svg>
                    </button>
                    <button @click="device = 'desktop'" class="p-1 rounded"
                            :class="{'bg-blue-50 text-blue-600': device == 'desktop'}">
                        <svg class="w-10 h-7 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58 53">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                  d="M2 1h54c.6 0 1 .4 1 1v36.5H1V2c0-.6.4-1 1-1ZM1 39.5V43c0 .6.4 1 1 1h54c.6 0 1-.4 1-1v-3.5H1Zm57 0V43a2 2 0 0 1-2 2H36.5l1 4.9v.1H40c.6 0 1 .4 1 1v1c0 .6-.4 1-1 1H19a1 1 0 0 1-1-1v-1c0-.6.4-1 1-1h2.5v-.1l1-4.9H2a2 2 0 0 1-2-2V2C0 .9.9 0 2 0h54a2 2 0 0 1 2 2v37.5ZM36.5 50l-1-4.9V45h-12v.1l-1 4.9h14ZM54 42a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm-35 9h21v1H19v-1Z"/>
                        </svg>
                    </button>
                </div>
