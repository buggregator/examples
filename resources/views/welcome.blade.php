...
<div id="app" class="h-screen">
        ...
        <header class="flex justify-between items-center">
            ...
            <div class="py-2 px-3 flex justify-end gap-6">
                <a href="https://docs.buggregator.dev" target="_blank"
                   class="text-lg underline underline-offset-1 hover:no-underline text-gray-800 font-bold">
                    Docs
                </a>
    ...
    <div>
        <div class="mx-auto py-10 px-5 md:px-8 lg:px-16 my-10 flex flex-col items-center">
            <h1 class="text-3xl sm:text-4xl lg:text-5xl leading-none font-extrabold tracking-tight mt-6 mb-4 text-center">
            ...
            <div class="text-sm mb-6 border bg-white rounded-lg px-5 py-3">
                <p class="max-w-screen-lg font-medium text-gray-400 mb-2">
                    All you need to do is to run the following command in your terminal:
                </p>
                <div
                    ...
                    docker run -p 8000:8000 -p 1025:1025 -p 9912:9912 -p 9913:9913
    ...
    <div class="relative">
        ...
        <div class="max-w-screen-lg xl:max-w-screen-xl mx-auto py-10 px-5 md:px-8 lg:px-16">
            ...
            <div class="mb-5 sm:mb-12 md:mb-16 lg:mb-19 border p-10 rounded-xl" id="{{ $group }}">
    ...
    <div class="max-w-screen-lg xl:max-w-screen-xl mx-auto py-10 px-5 md:px-8 lg:px-16">
        <div class="mb-5 sm:mb-12 md:mb-16 lg:mb-19">
            <h3 class="text-3xl lg:text-5xl leading-none font-extrabold text-blue-800 tracking-tight mb-8">
                Features
            </h3>

            <div class="flex gap-4">
                <div class="border p-8 rounded-lg w-1/2 flex flex-col gap-4">
            ...
            <div class="border p-8 rounded-lg bg-blue-50 w-full flex flex-col gap-4 mt-4">
